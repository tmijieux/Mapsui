...
namespace Mapsui.UI.Objects
{
    ...
    public class Drawable : BindableObject, IClickable, IFeatureProvider
    {
        ...
        public static readonly BindableProperty StrokeColorProperty = BindableProperty.Create(nameof(StrokeColor), typeof(Microsoft.Maui.Graphics.Color), typeof(Circle), Microsoft.Maui.Graphics.Color.FromArgb("#000000"));
        ...
        {
            get => (Microsoft.Maui.Graphics.Color)GetValue(StrokeColorProperty);
