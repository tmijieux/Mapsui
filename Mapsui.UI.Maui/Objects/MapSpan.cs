...
namespace Mapsui.UI.Maui
{
    ...
    public class MapSpan
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Mapsui.UI.Maui.MapSpan"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the specified <see cref="object"/> is equal to the current <see cref="T:Mapsui.UI.Maui.MapSpan"/>
        /// </summary>
        /// <param name="obj">The <see cref="object"/> to compare with current <see cref="T:Mapsui.UI.Maui.MapSpan"/></param>
        /// <returns><c>true</c> if the specified <see cref="object"/> is equal to the current
        /// <see cref="T:Mapsui.UI.Maui.MapSpan"/>; otherwise, <c>false</c>.</returns>
