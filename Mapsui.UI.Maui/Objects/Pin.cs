...
namespace Mapsui.UI.Maui
{
    public class Pin : BindableObject, IFeatureProvider
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Mapsui.UI.Maui.Pin"/> class
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the specified <see cref="object"/> is equal to the current <see cref="T:Mapsui.UI.Maui.Pin"/>.
        /// </summary>
        /// <param name="obj">The <see cref="object"/> to compare with the current <see cref="T:Mapsui.UI.Maui.Pin"/>.</param>
        /// <returns><c>true</c> if the specified <see cref="object"/> is equal to the current
        /// <see cref="T:Mapsui.UI.Maui.Pin"/>; otherwise, <c>false</c>.</returns>
