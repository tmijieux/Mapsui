...
namespace Mapsui.UI.Maui
{
    ...
    public struct Distance
    {
        ...
        /// <summary>
        /// Constructor for <see cref="T:Mapsui.UI.Maui.Distance"/> object.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the specified <see cref="Mapsui.UI.Maui.Distance"/> is equal to the current <see cref="T:Mapsui.UI.Maui.Distance"/>.
        /// </summary>
        /// <param name="other">The <see cref="Mapsui.UI.Maui.Distance"/> to compare with the current <see cref="T:Mapsui.UI.Maui.Distance"/></param>
        /// <returns><c>True</c> if the specified <see cref="Mapsui.UI.Maui.Distance"/> is equal to the current
        /// <see cref="T:Mapsui.UI.Maui.Distance"/>; otherwise, <c>false</c>.</returns>
